  ...
  const handleDelete = () => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        // Redirect to clients page after deletion
        setTimeout(() => {
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-200">
                    This action cannot be undone. The client and all associated projects, tickets, and history will be permanently deleted.
                  </p>
                </div>
              </div>
            </div>
